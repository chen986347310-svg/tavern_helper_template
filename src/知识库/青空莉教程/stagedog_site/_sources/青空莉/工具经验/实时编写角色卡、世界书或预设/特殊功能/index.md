...
## 让 AI 帮你修改整个角色卡/世界书/预设

既然角色卡/世界书/预设条目已经被脚本映射为本地文件, 你显然可以让 AI 直接帮你修改角色卡/世界书/预设, 你可以使用{doc}`Cursor、Augment、RooCode、Cline、Claude Code、Gemini CLI 等各种 AI 编程助手 </青空莉/工具经验/实时编写前端界面或脚本/环境准备/index>`.
...
同步脚本对于角色卡、预设或世界书条目的提示词, 支持内嵌提示词内容或外链提示词文件, 分别用`内容`或`文件`字段来指定.
